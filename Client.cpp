...
private:
	...
	ByteArray data;
	ByteArray u_name; // used for the user name
	std::string data_str;
	std:: string user; // for user name
...
public:
	...
	virtual long ThreadMain()
	{
        ...
        {
			std:: cout << "Enter your name and Message: " << std:: endl;
			while (!terminate)
			{
